  ...
  return (
    ...
    <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
        <div className='flex justify-between items-center pb-3'>
            ...
            <div className='m-fit ml-auto text-2xl hover:text-red-600 cursor-pointer' onClick={onClose}>
                <IoMdClose />
            </div>
        </div>
                        ...
                        {data.ProductImage.map((el, index) => {
                            return (
                                <div className='relative group' key={index}>
                                    ...
                                    />
                                    <div className='absolute bottom-0 right-0 text-white bg-red-600 rounded-full hidden group-hover:block cursor-pointer' onClick={() => handleDeleteProductImages(index)}>
                                        <MdDelete />
                                    </div>
                                </div>
                            );
